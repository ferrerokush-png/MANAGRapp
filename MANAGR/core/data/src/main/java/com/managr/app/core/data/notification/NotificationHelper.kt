...
import com.managr.app.core.data.R
...
class NotificationHelper(private val context: Context) {
    ...
    fun showReleaseReminder(
        ...
        val notification = NotificationCompat.Builder(context, Constants.Notification.CHANNEL_ID_RELEASES)
            .setSmallIcon(R.drawable.ic_stat_managr)
    ...
    private fun createProjectDetailIntent(projectId: Long): PendingIntent {
        val target: Intent = try {
            ...
            val cls = Class.forName("com.managr.app.personal.MainActivity")
            Intent(context, cls)
    ...
    private fun createMarkUploadedIntent(projectId: Long): PendingIntent {
        ...
        intent.setClassName(context, "com.managr.app.core.data.notification.MarkUploadedReceiver")
    ...
    private fun createMarkTaskCompleteIntent(taskId: Long): PendingIntent {
        ...
        intent.setClassName(context, "com.managr.app.core.data.notification.MarkTaskCompleteReceiver")
    ...
    companion object {
        const val ACTION_MARK_UPLOADED = "com.managr.app.MARK_UPLOADED"
        const val ACTION_MARK_TASK_COMPLETE = "com.managr.app.MARK_TASK_COMPLETE"
