...
import com.managr.app.core.data.local.entity.StreamingMetricsEntity
...
interface AnalyticsDao {
    ...
    @Query("SELECT * FROM streaming_metrics ORDER BY date DESC")
    fun getAllStreamingMetrics(): Flow<List<StreamingMetricsEntity>>

    @Query("DELETE FROM streaming_metrics")
    suspend fun deleteAllStreamingMetrics()
}
