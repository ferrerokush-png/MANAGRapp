package com.managr.app.personal.domain.usecase.project
...
class DeleteProjectUseCase(private val repo: ProjectRepository) {
    suspend operator fun invoke(projectId: Long) = repo.deleteProject(Project(id = projectId, title = "", artistName = "", type = com.managr.app.core.domain.model.ReleaseType.SINGLE, releaseDate = java.time.LocalDate.now(), artworkUri = null, genre = "", status = com.managr.app.core.domain.model.ProjectStatus.PLANNING, createdAt = 0, updatedAt = 0))
}
