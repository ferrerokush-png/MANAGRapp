package com.managr.app.personal.domain.usecase.task
...
class DeleteTaskUseCase(private val repo: TaskRepository) {
    suspend operator fun invoke(taskId: Long) = repo.deleteTask(Task(id = taskId, projectId = 0, title = "", description = "", phase = com.managr.app.core.domain.model.TaskPhase.PRE_PRODUCTION, priority = com.managr.app.core.domain.model.TaskPriority.MEDIUM, status = com.managr.app.core.domain.model.TaskStatus.PENDING, dueDate = java.time.LocalDate.now(), createdAt = 0, updatedAt = 0))
}
...
class DeleteSubTaskUseCase(private val repo: TaskRepository) {
    suspend operator fun invoke(subTaskId: Long) = repo.deleteTask(Task(id = subTaskId, projectId = 0, title = "", description = "", phase = com.managr.app.core.domain.model.TaskPhase.PRE_PRODUCTION, priority = com.managr.app.core.domain.model.TaskPriority.MEDIUM, status = com.managr.app.core.domain.model.TaskStatus.PENDING, dueDate = java.time.LocalDate.now(), createdAt = 0, updatedAt = 0))
}
